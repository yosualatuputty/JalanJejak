const catalogItems = [
    ...
    { id: 12, name: "Babi Bagong", nomenclature:"Sus verrucosus", kelangkaan: "Langka", taksonomi: "Hewan", bahaya: "Hati-hati", kegunaan: "Non Konsumsi", image: "image3.jpg", deskripsi: "Hewan ini memiliki bobot hingga 108 kg. Hewan ini berwarna hitam dan memiliki surai yang memanjang dari kepala hingga ekor di bagian punggungnya. Babi ini endemik di pulau Jawa dan Bawean dan dianggap punah di pulau Madura." },
    ...
    { id: 16, name: "Jamur Tudung Pengantin", nomenclature:"Phallus indusiatus", kelangkaan: "Tidak Langka", taksonomi: "Fungi", bahaya: "Tidak Berbahaya", kegunaan: "Konsumsi Herbal", image: "image3.jpg", deskripsi: "Jamur ini dapat tumbuh pada lingkungan dengan suhu berkisar 21-25 derajat Celcius dan kelembaban relatif berkisar 45%-85% dan dapat tumbuh sendiri maupun berkelompok. Jamur ini mengandung 7 asam amino esensial, 12 ion logam penting, dan tinggi vitamin E yang berkhasiat pada mata dan sistem kardiovaskular." },
    ...
    items.forEach(item => {
      ...
      catalogItem.innerHTML = `
        ...
        <div class="card-content">
          ...
          <div class="text">
          <p><div class="simbol"><img src="simbol/${item.kelangkaan}.svg"></div>${item.kelangkaan}</p>
          <p><div class="simbol"><img src="simbol/${item.taksonomi}.svg"></div>${item.taksonomi}</p>
          <p><div class="simbol"><img src="simbol/${item.bahaya}.svg"></div>${item.bahaya}</p>
          <p><div class="simbol"><img src="simbol/${item.kegunaan}.svg"></div>${item.kegunaan}</p>
          </div>
          <div class="desc">
